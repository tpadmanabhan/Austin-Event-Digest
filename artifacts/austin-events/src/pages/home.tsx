          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="relative z-10">
                ...
                {/* Headline */}
                <h3
                  className="font-serif text-2xl sm:text-3xl font-extrabold mb-1 leading-tight"
                  style={{ color: "#fff" }}
                >
                  The best deal in Austin —
                </h3>
                <h3
                  className="font-serif text-2xl sm:text-3xl font-extrabold mb-4 leading-tight"
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block text-sm font-bold no-underline px-7 py-3 rounded-full text-center transition-opacity hover:opacity-90"
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="inline-block text-sm font-bold no-underline px-7 py-3 rounded-full text-center transition-opacity hover:opacity-90"
                    style={{ background: "rgba(255,255,255,0.1)", color: "#fde68a", border: "1.5px solid rgba(255,255,255,0.25)" }}
                  >
