...
export const T = {
  ...
  ja: {
    ...
    heroMission: "パーソナライズされたイベント発見と、そこへ行くための手段を解決します。あなたのコミュニティの変革エージェントになろう。生活費が高いので、地元のお得情報を提供し、生活を手頃に保ちます。AustinCares デイリーディールズ機能は今",
    heroMissionLive: "ライブ",
    heroMissionSuffix: "近くの街にも来る予定です。",
    heroLuddite: "ラッダイトの夢",
