 ...
 * Public endpoint — allows unauthenticated uploads for community deal submissions.
 * Returns a presigned GCS PUT URL. The client uploads the file directly to GCS.
 */
...
/**
 * GET /storage/objects/*
 * Serve private objects — publicly accessible (deal photos are community-submitted).
 */
