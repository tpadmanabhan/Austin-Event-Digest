...
export function buildDigestEmailHtml(digest: {
  ...
  const theme = slug === "portland" ? {
    ...
    headerGradient: "linear-gradient(135deg, #0a1628 0%, #162444 55%, #1a3a6b 100%)",
    primary: "#003087",
    primaryBtn: "#003087",
    primaryDark: "#0a1628",
    primaryLight: "#e8eef8",
    ...
    headerEmoji: "🏛️",
    eventBtnColor: "#003087",
    eventBtnBorder: "#003087",
    pillText: "rgba(232,238,248,0.9)",
    pillBorder: "rgba(0,48,135,0.35)",
    rideBtnBg: "#003087",
    rideBtnColor: "#fff",
  } : slug === "brushycreek" ? {
