...
export function buildDigestEmailHtml(digest: {
  ...
  const theme = slug === "portland" ? {
    ...
    headerGradient: "linear-gradient(135deg, #1a0000 0%, #4d0000 55%, #CC0000 100%)",
    primary: "#CC0000",
    primaryBtn: "#CC0000",
    primaryDark: "#4d0000",
    primaryLight: "#fff0f0",
    ...
    headerEmoji: "🗼",
    eventBtnColor: "#CC0000",
    eventBtnBorder: "#CC0000",
    pillText: "rgba(255,240,240,0.9)",
    pillBorder: "rgba(204,0,0,0.35)",
    rideBtnBg: "#CC0000",
    rideBtnColor: "#fff",
  } : slug === "brushycreek" ? {
